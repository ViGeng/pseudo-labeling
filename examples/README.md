...
| 12  | ImageStatsRF            | 12 hand-crafted stats           | Random Forest ensemble: robust non-linear baseline using stats              |
| 13  | FrozenBackboneKNN       | SqueezeNet features (512-d)     | Non-parametric baseline: retrieves similar images to predict difficulty     |
| 14  | FinetunedEfficientNetB0 | raw images (224×224×3)          | Sota efficient architecture: balances accuracy and FLOPs better than ResNet |
...
| 12  | ImageStatsRF            | pre   | 12 image stats                                       | 2/4-class label + probabilities |
| 13  | FrozenBackboneKNN       | pre   | SqueezeNet1_0 GAP features (512-d)                   | 2/4-class label + probabilities |
| 14  | FinetunedEfficientNetB0 | pre   | raw image tensor (3×224×224)                         | 2/4-class label + probabilities |
